          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4 text-white">
              <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
                <x-div-link href="/" :active="request()->is('/')">Home</a></x-div-link>
                <x-div-link href="/jobs" :active="request()->is('jobs')">Jobs</a></x-div-link>
                <x-div-link href="/contact" :active="request()->is('contact')">Contact</a></x-div-link>
